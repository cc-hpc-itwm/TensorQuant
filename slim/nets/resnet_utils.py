...
def subsample(inputs, factor, max_pool2d, scope=None):
...
def conv2d_same(inputs, num_outputs, kernel_size, stride, conv2d, rate=1, scope=None):
  ...
  """
  if stride == 1:
    return conv2d(inputs, num_outputs, kernel_size, stride=1, rate=rate,
...
@slim.add_arg_scope
def stack_blocks_dense(net, blocks, conv2d, max_pool2d, output_stride=None,
